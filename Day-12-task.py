...
myjsonfile = open(r'C:\Users\PEER\Desktop\Python Internship\Python-Internship\Day12Task.json','r')
...
"""
#output = {'name': 'Irfan', 'age': 19, 'Student': True, 'Department': 'Computer Science', 'Percentage': 97.6, 'Arrears': None,
